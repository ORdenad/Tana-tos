...
if (iconMenu) {
	iconMenu.addEventListener("click", function () {
		...
		headerbody.classList.toggle("lock");
		menuBody.classList.toggle("active");

			//при нажиманні, меню закривається
...
if (document.querySelector('.review-slider')) {
	let brandsSlider = new Swiper('.review-slider__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.review-slider__arrow_next',
			prevEl: '.review-slider__arrow_prev',
		},
		// breakpoints: {
		// 	320: {
		// 		slidesPerView: 1,
...
if (document.querySelector('.slider-team')) {
	let brandsSlider = new Swiper('.slider-team__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 4,
		spaceBetween: 0,
